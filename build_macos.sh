...
du -sh "dist/Turdus_M3rula.app"
echo ""
echo "🚀 To run the application:"
echo "   open 'dist/Turdus_M3rula.app'"
echo ""
echo "📦 To create distribution package:"
echo "   cd dist && zip -r 'Turdus_M3rula_macOS_$TARGET_ARCH.zip' 'Turdus_M3rula.app'"
echo ""
echo "⚠️  Note: First launch may require:"
